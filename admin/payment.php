  ...
  <div class="container-fluid dashboard font">
    <div class="row min-vh-100">
      <div class="col-sm-2  px-4 ">
        ...
        <nav class="">
          <ul>
           ...
           <li><a href="salesreport.php" class="font">Sales Report</a></li>
            <li><a href="payment.php" class="font active">Payments</a></li>
      ...
      <div class="col-sm-10 p-3">
        ...
        <p class="text-capitalize h4  ">Payment Details</p>
